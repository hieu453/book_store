                ...
                <div class="w-full md:w-1/2 px-4">
                    ...
                    <div class="mb-6">
                        ...
                        <ul class="list-disc list-inside text-gray-700">
                            ...
                            <li>Published date: {{ product.published_date }}</li>
                        </ul>
                    </div>
                    <div class="mb-6">
                    ...
                    <div class="flex space-x-4 mb-6">
                        ...
                        <button
                            ...
                            class="bg-indigo-600 flex gap-2 items-center text-white px-6 py-2 rounded-md hover:bg-indigo-900 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
